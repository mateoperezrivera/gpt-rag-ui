...
.DESCRIPTION
    ...
    - Fetches required keys (CONTAINER_REGISTRY_NAME, CONTAINER_REGISTRY_LOGIN_SERVER, RESOURCE_GROUP_NAME, FRONTEND_APP_NAME) from Azure App Configuration with label "gpt-rag".
